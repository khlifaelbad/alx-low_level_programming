 ...
 */
 ...
 {
    /* we have an argument with return data type void*/
    /* print numbers by use _putchar*/
    ...
    if (n < 0) 
    {
        _putchar('-'); /* print (-) if i get negative num */
         num = -n; /* then will negative number */
    }
    ...
    _putchar((num % 10) + '0'); /* then well print each num by a num to end right number bu use num % 10 
    for example 4 + 48 = 52 << ASCII convert 52 as decimal to see number */
 }